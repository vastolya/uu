      ...
      <PageSection className="">
        ...
        <div className="col-span-4 flex flex-col gap-2 mb-[12.5rem]">
          <Image
            ...
            alt=""
            sizes="auto"
            className="h-[43rem] w-full object-cover rounded-[var(--radius-sm)]"
          />
          <Image
            src={Okhta2}
            alt=""
