  ...
  return (
    <>
      ...
      <PageSection className="">
        ...
        <h1 className="pb-10 col-span-8">Жилая квартира </h1>
        ...
        <div className="col-span-4">
          <div className="min-h-[215.25rem] mb-[12.5rem]">
            <section className="sticky top-20">
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 py-4 border-b-[0.125rem] subtitle border-[var(--color-border-gray)]">
                ...
                <p className="col-span-2 text-[var(--color-gray)]">87 м²</p>
              </div>

              <p className="subtitle-bold pb-4 pt-6">Стандартная планировка</p>

              <div className="flex flex-wrap gap-1 pb-[19.75rem]">
              ...
              <h3>Городская квартира в многоквартирном доме</h3>
            </section>
          </div>
        </div>
        ...
        <div className="col-span-4">
          <div className="min-h-[421rem] mb-[12.5rem]">
            <section className="sticky top-20">
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 pb-6">
                <h3 className="col-span-2">Стилевые</h3>
        ...
        <div className="col-span-4">
          <div className="min-h-[144.25rem] mb-[12.5rem] ">
            <section className="sticky top-20 ">
        ...
        <div className="col-span-4">
          <div className="min-h-[310rem] mb-[12.5rem] ">
            <section className="sticky top-20 ">
              <h2 className="!text-[var(--color-gray)] pb-10 ">
                Дизайн-решения
              </h2>
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 py-4 border-b-[0.125rem] subtitle border-[var(--color-border-gray)] box-border">
                <p className="col-span-2 my-auto px-2">Стены</p>
                <p className="col-span-2 text-[var(--color-gray)]">
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 py-4 border-b-[0.125rem] subtitle border-[var(--color-border-gray)] box-border mb-4">
                <p className="col-span-2 my-auto px-2">Пол</p>
                <p className="col-span-2 text-[var(--color-gray)]">
                  Светлое дерево
                </p>
              </div>
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 py-4  subtitle mb-4">
                <p className="col-span-2 my-auto px-2">Декор</p>
                <p className="col-span-2 text-[var(--color-gray)]">
              ...
              <div className="md:grid md:grid-cols-4 md:gap-x-6 py-4 border-b-[0.125rem] subtitle border-[var(--color-border-gray)] box-border">
                <p className="col-span-2 my-auto px-2">Центральный элемент</p>
                <p className="col-span-2 text-[var(--color-gray)]">
